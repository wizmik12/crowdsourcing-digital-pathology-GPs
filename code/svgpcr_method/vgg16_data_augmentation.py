...
#Loading data
X_train, y_train = read_images('../Train_non_experts_simple')
...
with open('./Results/results_gold_vgg_data_aug.txt', 'w') as the_file:
...
with open("vgg16_gold.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("vgg16_gold.h5")
